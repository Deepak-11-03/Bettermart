...
function privacypolicy() {
  return (
    <div className={style.main} style={{ fontWeight: "100" ,padding:"25px" }}>
      <h1 style={{ textAlign: "center" }}>Privacy Policy</h1>
      <br />

      <p>
        <strong>Effective Date: 24-03-2023</strong>
      </p>
      <h3>Your privacy is important to us</h3>

      <p>
        It is Bettermart's policy to respect your privacy regarding any
        information we may collect while operating our website. This Privacy
        Policy applies to{" "}
        <a href="https://better-mart.netlify.app/"> better-mart.netlify.app/</a>{" "}
        (hereinafter, "us", "we", or "better-mart.netlify.app/"). We respect
      ...
      <p>
        Certain visitors to Bettermart's websites choose to interact with
        Bettermart in ways that require Bettermart to gather
        personally-identifying information. The amount and type of information
        that Bettermart gathers depends on the nature of the interaction. For
        example, we ask visitors who leave a comment at
        https://better-mart.netlify.app/ to provide a username and email
        address.
      </p>
      ...
      <p>
        Bettermart discloses potentially personally-identifying and
        personally-identifying information only to those of its employees,
        contractors and affiliated organizations that (i) need to know that
        information in order to process it on Bettermart's behalf or to provide
        services available at Bettermart's website, and (ii) that have agreed
        ...
        using Bettermart's website, you consent to the transfer of such
        information to them. Bettermart will not rent or sell potentially
        ...
        as described above, Bettermart discloses potentially
        ...
        when Bettermart believes in good faith that disclosure is reasonably
        necessary to protect the property or rights of Bettermart, third parties
        or the public at large.
      </p>
      <p>
        If you are a registered user of https://better-mart.netlify.app/ and
        have supplied your email address, Bettermart may occasionally send you
        an email to tell you about new features, solicit your feedback, or just
        keep you up to date with what's going on with Bettermart and our
        ...
        users. Bettermart takes all measures reasonably necessary to protect
      ...
      <p>
        To enrich and perfect your online experience, Bettermart uses "Cookies",
      ...
      <p>
        ...
        time the visitor returns. Bettermart uses cookies to help Bettermart
        identify and track visitors, their usage of
        https://better-mart.netlify.app/, and their website access preferences.
        Bettermart visitors who do not wish to have cookies placed on their
        computers should set their browsers to refuse cookies before using
        Bettermart's websites, with the drawback that certain features of
        Bettermart's websites may not function properly without the aid of
        cookies.
      </p>
      <p>
        By continuing to navigate our website without changing your cookie
        settings, you hereby acknowledge and agree to Bettermart's use of
        cookies.
      </p>
      ...
      <p>
        Those who engage in transactions with Bettermart – by purchasing
        Bettermart's services or products, are asked to provide additional
        ...
        Bettermart collects such information only insofar as is necessary or
        appropriate to fulfill the purpose of the visitor's interaction with
        Bettermart. Bettermart does not disclose personally-identifying
      ...
      <p>
        Although most changes are likely to be minor, Bettermart may change its
        Privacy Policy from time to time, and in Bettermart's sole discretion.
        Bettermart encourages visitors to frequently check this page for any
      ...
      <p>
        ...
        via <a href="mailto:dp121571@gmail.com">email</a> or{" "}
        <a href="tel:">phone</a>.
      </p>
